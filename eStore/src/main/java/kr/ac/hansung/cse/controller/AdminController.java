...
public class AdminController {
	...
	@RequestMapping(value="/productInventory/deleteProduct/{id}", method=RequestMethod.GET) // 중괄호 안에 띄어쓰기하면 오류발생
	...
	@RequestMapping(value="/productInventory/updateProduct/{id}", method=RequestMethod.GET) // 중괄호 안에 띄어쓰기하면 오류발생
